...
<!-- .slide: data-background-image="images/migi-bike.png" data-background-opacity="0.35" -->
## it started in Delft!
Note:
...
<!-- .slide: data-background-image="images/migi-watchduino.png" data-background-opacity="0.21" -->
## Watchduino
Note:
...
<!-- .slide: data-background-image="images/inpulse.png" data-background-opacity="0.21" -->
## the Allerta inPulse
Note:
...
<!-- .slide: data-background-image="images/kickstarter.png" data-background-opacity="0.14" -->
### Kickstarter
Note:
...
<!-- .slide: data-background-image="images/PW-DOS-Workout.jpg" data-background-opacity="0.21" -->
### SDK
#### PW-DOS
Note:
...
<!-- .slide: data-background-image="images/prb.png" data-background-opacity="0.42" -->
...
<!-- .slide: data-background-image="images/ottawa.jpeg" data-background-opacity="0.21" -->
...
<!-- .slide: data-background-image="images/smartwatch-meetup.jpg" data-background-opacity="0.21" -->
### Pebble A2 (Rockstar)
#### the book
#### appstore curation
Note:
...
<!-- .slide: data-background-image="images/pogo.jpeg" data-background-opacity="0.21" data-background-size="35%" data-background-position="50% 63%" -->
### Pokemon GO Radar
### smartstraps
Note:
...
<!-- .slide: data-background-image="images/the-information.png" data-background-opacity="0.14" -->
### The Information
Note:
...
<!-- .slide: data-background-image="images/pebble-shrugged.png" data-background-opacity="0.14" -->
### confirmation
Note:
...
<!-- .slide: data-background-image="images/feels.png" data-background-opacity="0.14" -->
### a loveletter
Note:
...
<!-- .slide: data-background-image="images/team.png" data-background-opacity="0.14" -->
### Rebbleion
Note:
...
<!-- .slide: data-background-image="images/panic.png" data-background-opacity="0.14" -->
### appstore
Note:
...
<!-- .slide: data-background-image="images/checkerboard.png" data-background-opacity="0.14" -->
### firmware
Note:
...
<!-- .slide: data-background-image="images/mascot.png" data-background-opacity="0.14" -->
### archive
Note:
...
<!-- .slide: data-background-image="images/cu3.png" data-background-opacity="0.14" -->
### FreeRTOS-Pebble
Note:
...
<!-- .slide: data-background-image="images/peek.gif" data-background-opacity="0.14" data-background-size="50%" data-background-position="50% 56%" -->
### UX / BT
Note:
...
<!-- .slide: data-background-image="images/wareable-20180125.png" data-background-opacity="0.14" data-background-size="84%" -->
### a firm deadline...
...
<!-- .slide: data-background-image="images/pebbleXfitbit.jpg" data-background-opacity="0.14" -->
...
<!-- .slide: data-background-image="images/peach.jpg" data-background-opacity="0.14" -->
### a new hope...
...
<!-- .slide: data-background-image="images/soulver.png" data-background-opacity="0.14" -->
### the Rebble Alliance
...
<!-- .slide: data-background-image="images/migi-tweet.png" data-background-opacity="0.14" data-background-size="91%" -->
### it's Rebble time!
...
<!-- .slide: data-background-image="images/dialer.png" data-background-opacity="0.14" -->
...
<!-- .slide: data-background-image="images/pebble-dev.png" data-background-opacity="0.21" -->
### Pebble
...
<!-- .slide: data-background-image="images/fitbit.png" data-background-opacity="0.14" -->
### Fitbit
...
<!-- .slide: data-background-image="images/contrib.png" data-background-opacity="0.14" -->
### contribs
...
<!-- .slide: data-background-image="images/howto.png" data-background-opacity="0.14" -->
### support
...
<!-- .slide: data-background-image="images/subscribe.png" data-background-opacity="0.14" -->
### subscribers
...
<!-- .slide: data-background-image="images/pebble-life.jpeg" data-background-opacity="0.14" -->
### believers
...
<!-- .slide: data-background-image="images/rebble-hardware.png" data-background-opacity="0.14" -->
### hardware
...
<!-- .slide: data-background-image="images/discord.png" data-background-opacity="0.14" -->
### community
